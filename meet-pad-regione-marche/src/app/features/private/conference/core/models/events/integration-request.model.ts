...
export class IntegrationRequest extends Event {
    administration: string = '';
    body: string = '';
    document: EventDocument = EventDocument.fromDto('','','',new DateModel(new Date()),
    Object.assign(
        {},
        environment.defaultComboBox.conference.events.integrationRequest
                .document.category
    ));

    constructor(event?: Partial<IntegrationRequest>) {
        super(event);
