...
export class InterectionFile extends BaseFile {
    type = FileType.INTERETION;
    subType?;
    visibility: ComboBox[] = [];
    category: ComboBox = Object.assign(
        {},
        environment.defaultComboBox.conference.documentation.interactionCategory
    );

    constructor(file?: Partial<InterectionFile>) {
        super(file);
        if (file) {
