...
@Component({
    ...
    selector: 'admin-conference-list',
    templateUrl: './conference-list.component.html',
    styleUrls: ['./conference-list.component.scss']
})
export class ConferenceListComponent extends AutoUnsubscribe
    ...
    defineTableStructure(
        ...
        structure.push(
            new TableField(
                this.i18nService.translate(
                    'AUTHORITIES.PROCEDING.CONFERENCE.LIST.ID'
                ),
                'NUMBER',
                'id',
                true
        ...
        structure.push(
            new TableField(
                this.i18nService.translate(
                    'AUTHORITIES.PROCEDING.CONFERENCE.LIST.REQUEST_REFERENCE'
                ),
                'NORMAL',
                'requestReference',
                false
        ...
        structure.push(
            new TableField(
                this.i18nService.translate(
                    'AUTHORITIES.PROCEDING.CONFERENCE.LIST.TYPE'
                ),
                'NORMAL',
        ...
        structure.push(
            new TableField(
                this.i18nService.translate(
                    'AUTHORITIES.PROCEDING.CONFERENCE.LIST.STATE'
                ),
                'NORMAL',
                'state.value',
                false
        ...
        structure.push(
            new TableField(
                this.i18nService.translate(
                    'AUTHORITIES.PROCEDING.CONFERENCE.LIST.PROCEEDING_ADMINISTRATION'
                ),
                'NORMAL',
                'proceedingCompany.name',
                false
            )
        );
        ...
        structure.push(
            new TemplateField(
                this.i18nService.translate(
                    'AUTHORITIES.PROCEDING.CONFERENCE.LIST.ACTIONS.TITLE'
                ),
    ...
    public search(
        ...
        return this.conferenceService
            .getConferences(this.buildCriteriaDto(), query)
            .pipe(
                tap((results: WrapperGetData<SearchConference>) => {
                    ...
                    if (this.list.length === 0) {
                        this.toastr.warning(
                            this.i18nService.translate(
                                'AUTHORITIES.PROCEDING.CONFERENCE.SEARCH.TOASTR.EMPTY_SEARCH.TEXT'
                            ),
                            this.i18nService.translate(
                                'AUTHORITIES.PROCEDING.CONFERENCE.SEARCH.TOASTR.EMPTY_SEARCH.TITLE'
                            )
                        );
                    }
