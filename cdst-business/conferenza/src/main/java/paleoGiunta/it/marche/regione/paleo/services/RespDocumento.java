...
public class RespDocumento  extends paleoGiunta.it.marche.regione.paleo.services.BEBase  implements java.io.Serializable {
    private java.lang.String[] classificazioni;

    private java.util.Calendar dataDocumento;
    
    private paleoGiunta.it.marche.regione.paleo.services.ProcedimentoInfo datiProcedimento;

    private int docNumber;

    private java.lang.String oggetto;

    private paleoGiunta.it.marche.regione.paleo.services.OperatorePaleo proprietario;

    private java.lang.String segnaturaDocumento;

    private paleoGiunta.org.datacontract.schemas._2004._07.RegioneMarche_Protocollo_Common_Tipi.TipoDocumento tipoDocumento;
    ...
    public paleoGiunta.it.marche.regione.paleo.services.ProcedimentoInfo getDatiProcedimento() {
		return datiProcedimento;
	}

	public void setDatiProcedimento(paleoGiunta.it.marche.regione.paleo.services.ProcedimentoInfo datiProcedimento) {
		this.datiProcedimento = datiProcedimento;
	}
     ...
     * @return proprietario
     */
    public paleoGiunta.it.marche.regione.paleo.services.OperatorePaleo getProprietario() {
        return proprietario;
    }
     ...
     * @param proprietario
     */
    public void setProprietario(paleoGiunta.it.marche.regione.paleo.services.OperatorePaleo proprietario) {
        this.proprietario = proprietario;
    }
     ...
     */
    public paleoGiunta.org.datacontract.schemas._2004._07.RegioneMarche_Protocollo_Common_Tipi.TipoDocumento getTipoDocumento() {
        return tipoDocumento;
    }
     ...
     * @param tipoDocumento
     */
    public void setTipoDocumento(paleoGiunta.org.datacontract.schemas._2004._07.RegioneMarche_Protocollo_Common_Tipi.TipoDocumento tipoDocumento) {
        this.tipoDocumento = tipoDocumento;
    }
