...
public class RespAddAllegati  extends paleoGiunta.it.marche.regione.paleo.services.BEBase  implements java.io.Serializable {
    private paleoGiunta.it.marche.regione.paleo.services.AllegatoInfo[] allegati;
    ...
    public RespAddAllegati(
    		...
    		paleoGiunta.it.marche.regione.paleo.services.AllegatoInfo[] allegati,
     ...
     * @return allegati
     */
    public paleoGiunta.it.marche.regione.paleo.services.AllegatoInfo[] getAllegati() {
        return allegati;
    }
     ...
     * @param allegati
     */
    public void setAllegati(paleoGiunta.it.marche.regione.paleo.services.AllegatoInfo[] allegati) {
        this.allegati = allegati;
    }
