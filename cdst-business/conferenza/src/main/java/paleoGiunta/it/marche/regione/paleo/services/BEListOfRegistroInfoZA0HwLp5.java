/**
 * BEListOfRegistroInfoZA0HwLp5.java
 *
...
public class BEListOfRegistroInfoZA0HwLp5  implements java.io.Serializable {
    private paleoGiunta.it.marche.regione.paleo.services.RegistroInfo[] lista;

    private paleoGiunta.it.marche.regione.paleo.services.MessaggioRisultato messaggioRisultato;

    public BEListOfRegistroInfoZA0HwLp5() {
    }

    public BEListOfRegistroInfoZA0HwLp5(
    		paleoGiunta.it.marche.regione.paleo.services.RegistroInfo[] lista,
    ...
    /**
     * Gets the lista value for this BEListOfRegistroInfoZA0HwLp5.
     * 
     * @return lista
     */
    public paleoGiunta.it.marche.regione.paleo.services.RegistroInfo[] getLista() {
        return lista;
    }


    /**
     * Sets the lista value for this BEListOfRegistroInfoZA0HwLp5.
     * 
     * @param lista
     */
    public void setLista(paleoGiunta.it.marche.regione.paleo.services.RegistroInfo[] lista) {
        this.lista = lista;
    }


    /**
     * Gets the messaggioRisultato value for this BEListOfRegistroInfoZA0HwLp5.
     * 
    ...
    /**
     * Sets the messaggioRisultato value for this BEListOfRegistroInfoZA0HwLp5.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof BEListOfRegistroInfoZA0HwLp5)) return false;
        BEListOfRegistroInfoZA0HwLp5 other = (BEListOfRegistroInfoZA0HwLp5) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(BEListOfRegistroInfoZA0HwLp5.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://paleo.regione.marche.it/services/", "BEListOfRegistroInfoZA0hwLp5"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://paleo.regione.marche.it/services/", "RegistroInfo"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        elemField.setItemQName(new javax.xml.namespace.QName("http://paleo.regione.marche.it/services/", "RegistroInfo"));
