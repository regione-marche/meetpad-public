...
public class ReqProtocollo  extends paleoGiunta.it.marche.regione.paleo.services.ReqDocumento  implements java.io.Serializable {
    private java.lang.String codiceRegistro;

    private paleoGiunta.it.marche.regione.paleo.services.DatiEmergenza emergenza;
     ...
     * @return emergenza
     */
    public paleoGiunta.it.marche.regione.paleo.services.DatiEmergenza getEmergenza() {
        return emergenza;
    }
     ...
     * @param emergenza
     */
    public void setEmergenza(paleoGiunta.it.marche.regione.paleo.services.DatiEmergenza emergenza) {
        this.emergenza = emergenza;
    }
