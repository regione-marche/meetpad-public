...
public class Registro  extends paleoGiunta.it.marche.regione.paleo.services.BEBase  implements java.io.Serializable {
    ...
    /**
     * Gets the stato value for this Registro.
     * 
     * @return stato
     */
    ...
    /**
     * Sets the stato value for this Registro.
     * 
     * @param stato
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://paleo.regione.marche.it/services/", "Registro"));
