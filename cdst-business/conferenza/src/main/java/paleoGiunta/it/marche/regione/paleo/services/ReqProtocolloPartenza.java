...
public class ReqProtocolloPartenza  extends paleoGiunta.it.marche.regione.paleo.services.ReqProtocollo  implements java.io.Serializable {
    private paleoGiunta.it.marche.regione.paleo.services.Corrispondente[] destinatari;

    private paleoGiunta.it.marche.regione.paleo.services.Corrispondente[] destinatariCC;
    ...
    public ReqProtocolloPartenza(
           ...
           paleoGiunta.it.marche.regione.paleo.services.DatiEmergenza emergenza,
           java.lang.String segnaturaProtocolloPrecedente,
           paleoGiunta.it.marche.regione.paleo.services.Corrispondente[] destinatari,
           paleoGiunta.it.marche.regione.paleo.services.Corrispondente[] destinatariCC) {
        super(
            classificazioni,
            documentiAllegati,
            documentoPrincipale,
     ...
     * @return destinatari
     */
    public paleoGiunta.it.marche.regione.paleo.services.Corrispondente[] getDestinatari() {
        return destinatari;
    }
     ...
     * @param destinatari
     */
    public void setDestinatari(paleoGiunta.it.marche.regione.paleo.services.Corrispondente[] destinatari) {
        this.destinatari = destinatari;
    }
     ...
     */
    public paleoGiunta.it.marche.regione.paleo.services.Corrispondente[] getDestinatariCC() {
        return destinatariCC;
    }
     ...
     * @param destinatariCC
     */
    public void setDestinatariCC(paleoGiunta.it.marche.regione.paleo.services.Corrispondente[] destinatariCC) {
        this.destinatariCC = destinatariCC;
    }
