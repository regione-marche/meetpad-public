...
public class RespSpedisciProtocollo  extends paleoGiunta.it.marche.regione.paleo.services.BEBase  implements java.io.Serializable {
    private paleoGiunta.it.marche.regione.paleo.services.DestinatarioInfoInterop[] destinatari;

    private paleoGiunta.it.marche.regione.paleo.services.DestinatarioInfoInterop[] destinatariCC;
    ...
    public RespSpedisciProtocollo(
    		...
    		paleoGiunta.it.marche.regione.paleo.services.DestinatarioInfoInterop[] destinatari,
    		paleoGiunta.it.marche.regione.paleo.services.DestinatarioInfoInterop[] destinatariCC) {
        super(
            messaggioRisultato);
     ...
     * @return destinatari
     */
    public paleoGiunta.it.marche.regione.paleo.services.DestinatarioInfoInterop[] getDestinatari() {
        return destinatari;
    }
     ...
     * @param destinatari
     */
    public void setDestinatari(paleoGiunta.it.marche.regione.paleo.services.DestinatarioInfoInterop[] destinatari) {
        this.destinatari = destinatari;
    }
     ...
     */
    public paleoGiunta.it.marche.regione.paleo.services.DestinatarioInfoInterop[] getDestinatariCC() {
        return destinatariCC;
    }
     ...
     * @param destinatariCC
     */
    public void setDestinatariCC(paleoGiunta.it.marche.regione.paleo.services.DestinatarioInfoInterop[] destinatariCC) {
        this.destinatariCC = destinatariCC;
    }
