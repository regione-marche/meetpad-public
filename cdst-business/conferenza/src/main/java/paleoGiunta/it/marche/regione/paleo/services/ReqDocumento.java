...
public class ReqDocumento  implements java.io.Serializable {
    private paleoGiunta.it.marche.regione.paleo.services.Classificazione[] classificazioni;

    private paleoGiunta.it.marche.regione.paleo.services.Allegato[] documentiAllegati;

    private paleoGiunta.it.marche.regione.paleo.services.File documentoPrincipale;

    private boolean documentoPrincipaleAcquisitoIntegralmente;

    private paleoGiunta.it.marche.regione.paleo.services.TipoOriginale documentoPrincipaleOriginale;

    private java.lang.String note;

    private java.lang.String oggetto;

    private paleoGiunta.it.marche.regione.paleo.services.OperatorePaleo operatore;

    private boolean privato;

    private paleoGiunta.it.marche.regione.paleo.services.DatiProcedimento procedimento;

    private java.lang.String tipoDocumento;

    private paleoGiunta.it.marche.regione.paleo.services.Trasmissione trasmissione;

    public ReqDocumento() {
    }

    public ReqDocumento(
           paleoGiunta.it.marche.regione.paleo.services.Classificazione[] classificazioni,
           paleoGiunta.it.marche.regione.paleo.services.Allegato[] documentiAllegati,
           paleoGiunta.it.marche.regione.paleo.services.File documentoPrincipale,
           boolean documentoPrincipaleAcquisitoIntegralmente,
           paleoGiunta.it.marche.regione.paleo.services.TipoOriginale documentoPrincipaleOriginale,
           java.lang.String note,
           java.lang.String oggetto,
           paleoGiunta.it.marche.regione.paleo.services.OperatorePaleo operatore,
           boolean privato,
           paleoGiunta.it.marche.regione.paleo.services.DatiProcedimento procedimento,
           java.lang.String tipoDocumento,
           paleoGiunta.it.marche.regione.paleo.services.Trasmissione trasmissione) {
     ...
     */
    public paleoGiunta.it.marche.regione.paleo.services.Classificazione[] getClassificazioni() {
        return classificazioni;
    }
     ...
     */
    public void setClassificazioni(paleoGiunta.it.marche.regione.paleo.services.Classificazione[] classificazioni) {
        this.classificazioni = classificazioni;
    }
     ...
     */
    public paleoGiunta.it.marche.regione.paleo.services.Allegato[] getDocumentiAllegati() {
        return documentiAllegati;
    }
     ...
     */
    public void setDocumentiAllegati(paleoGiunta.it.marche.regione.paleo.services.Allegato[] documentiAllegati) {
        this.documentiAllegati = documentiAllegati;
    }
     ...
     */
    public paleoGiunta.it.marche.regione.paleo.services.File getDocumentoPrincipale() {
        return documentoPrincipale;
    }
     ...
     */
    public void setDocumentoPrincipale(paleoGiunta.it.marche.regione.paleo.services.File documentoPrincipale) {
        this.documentoPrincipale = documentoPrincipale;
    }
     ...
     */
    public paleoGiunta.it.marche.regione.paleo.services.TipoOriginale getDocumentoPrincipaleOriginale() {
        return documentoPrincipaleOriginale;
    }
     ...
     */
    public void setDocumentoPrincipaleOriginale(paleoGiunta.it.marche.regione.paleo.services.TipoOriginale documentoPrincipaleOriginale) {
        this.documentoPrincipaleOriginale = documentoPrincipaleOriginale;
    }
     ...
     * @return operatore
     */
    public paleoGiunta.it.marche.regione.paleo.services.OperatorePaleo getOperatore() {
        return operatore;
    }
     ...
     * @param operatore
     */
    public void setOperatore(paleoGiunta.it.marche.regione.paleo.services.OperatorePaleo operatore) {
        this.operatore = operatore;
    }
     ...
     * @return procedimento
     */
    public paleoGiunta.it.marche.regione.paleo.services.DatiProcedimento getProcedimento() {
        return procedimento;
    }
     ...
     * @param procedimento
     */
    public void setProcedimento(paleoGiunta.it.marche.regione.paleo.services.DatiProcedimento procedimento) {
        this.procedimento = procedimento;
    }
     ...
     * @return trasmissione
     */
    public paleoGiunta.it.marche.regione.paleo.services.Trasmissione getTrasmissione() {
        return trasmissione;
    }
     ...
     * @param trasmissione
     */
    public void setTrasmissione(paleoGiunta.it.marche.regione.paleo.services.Trasmissione trasmissione) {
        this.trasmissione = trasmissione;
    }
