...
public class RespDocumentoExt  extends paleoGiunta.it.marche.regione.paleo.services.RespDocumento  implements java.io.Serializable {
    private paleoGiunta.it.marche.regione.paleo.services.Allegato[] allegati;
     ...
     * @return allegati
     */
    public paleoGiunta.it.marche.regione.paleo.services.Allegato[] getAllegati() {
        return allegati;
    }
     ...
     * @param allegati
     */
    public void setAllegati(paleoGiunta.it.marche.regione.paleo.services.Allegato[] allegati) {
        this.allegati = allegati;
    }
