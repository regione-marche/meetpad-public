...
public class ReqProtocolloArrivo  extends paleoGiunta.it.marche.regione.paleo.services.ReqProtocollo  implements java.io.Serializable {
    private java.util.Calendar dataArrivo;

    private java.util.Calendar dataProtocolloMittente;

    private paleoGiunta.it.marche.regione.paleo.services.Corrispondente mittente;
     ...
     * @return mittente
     */
    public paleoGiunta.it.marche.regione.paleo.services.Corrispondente getMittente() {
        return mittente;
    }
     ...
     * @param mittente
     */
    public void setMittente(paleoGiunta.it.marche.regione.paleo.services.Corrispondente mittente) {
        this.mittente = mittente;
    }
