/**
 * BEListOfTitolarioInfoZA0HwLp5.java
 *
...
public class BEListOfTitolarioInfoZA0HwLp5  implements java.io.Serializable {
    private paleoGiunta.it.marche.regione.paleo.services.TitolarioInfo[] lista;

    private paleoGiunta.it.marche.regione.paleo.services.MessaggioRisultato messaggioRisultato;

    public BEListOfTitolarioInfoZA0HwLp5() {
    }

    public BEListOfTitolarioInfoZA0HwLp5(
    		paleoGiunta.it.marche.regione.paleo.services.TitolarioInfo[] lista,
    ...
    /**
     * Gets the lista value for this BEListOfTitolarioInfoZA0HwLp5.
     * 
     * @return lista
     */
    public paleoGiunta.it.marche.regione.paleo.services.TitolarioInfo[] getLista() {
        return lista;
    }


    /**
     * Sets the lista value for this BEListOfTitolarioInfoZA0HwLp5.
     * 
     * @param lista
     */
    public void setLista(paleoGiunta.it.marche.regione.paleo.services.TitolarioInfo[] lista) {
        this.lista = lista;
    }


    /**
     * Gets the messaggioRisultato value for this BEListOfTitolarioInfoZA0HwLp5.
     * 
    ...
    /**
     * Sets the messaggioRisultato value for this BEListOfTitolarioInfoZA0HwLp5.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof BEListOfTitolarioInfoZA0HwLp5)) return false;
        BEListOfTitolarioInfoZA0HwLp5 other = (BEListOfTitolarioInfoZA0HwLp5) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(BEListOfTitolarioInfoZA0HwLp5.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://paleo.regione.marche.it/services/", "BEListOfTitolarioInfoZA0hwLp5"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://paleo.regione.marche.it/services/", "TitolarioInfo"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        elemField.setItemQName(new javax.xml.namespace.QName("http://paleo.regione.marche.it/services/", "TitolarioInfo"));
