...
public class BEListOfUOInfoZA0HwLp5  implements java.io.Serializable {
    private paleoGiunta.it.marche.regione.paleo.services.UOInfo[] lista;

    private paleoGiunta.it.marche.regione.paleo.services.MessaggioRisultato messaggioRisultato;

    public BEListOfUOInfoZA0HwLp5() {
    }

    public BEListOfUOInfoZA0HwLp5(
    		paleoGiunta.it.marche.regione.paleo.services.UOInfo[] lista,
    ...
    /**
     * Gets the lista value for this BEListOfUOInfoZA0HwLp5.
     * 
     * @return lista
     */
    public paleoGiunta.it.marche.regione.paleo.services.UOInfo[] getLista() {
        return lista;
    }


    /**
     * Sets the lista value for this BEListOfUOInfoZA0HwLp5.
     * 
     * @param lista
     */
    public void setLista(paleoGiunta.it.marche.regione.paleo.services.UOInfo[] lista) {
        this.lista = lista;
    }


    /**
     * Gets the messaggioRisultato value for this BEListOfUOInfoZA0HwLp5.
     * 
    ...
    /**
     * Sets the messaggioRisultato value for this BEListOfUOInfoZA0HwLp5.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof BEListOfUOInfoZA0HwLp5)) return false;
        BEListOfUOInfoZA0HwLp5 other = (BEListOfUOInfoZA0HwLp5) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(BEListOfUOInfoZA0HwLp5.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://paleo.regione.marche.it/services/", "BEListOfUOInfoZA0hwLp5"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://paleo.regione.marche.it/services/", "UOInfo"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        elemField.setItemQName(new javax.xml.namespace.QName("http://paleo.regione.marche.it/services/", "UOInfo"));
