/**
 * BEListOfUtentePaleoZA0HwLp5.java
 *
...
public class BEListOfUtentePaleoZA0HwLp5  implements java.io.Serializable {
    private paleoGiunta.it.marche.regione.paleo.services.UtentePaleo[] lista;

    private paleoGiunta.it.marche.regione.paleo.services.MessaggioRisultato messaggioRisultato;

    public BEListOfUtentePaleoZA0HwLp5() {
    }

    public BEListOfUtentePaleoZA0HwLp5(
    		paleoGiunta.it.marche.regione.paleo.services.UtentePaleo[] lista,
    ...
    /**
     * Gets the lista value for this BEListOfUtentePaleoZA0HwLp5.
     * 
     * @return lista
     */
    public paleoGiunta.it.marche.regione.paleo.services.UtentePaleo[] getLista() {
        return lista;
    }


    /**
     * Sets the lista value for this BEListOfUtentePaleoZA0HwLp5.
     * 
     * @param lista
     */
    public void setLista(paleoGiunta.it.marche.regione.paleo.services.UtentePaleo[] lista) {
        this.lista = lista;
    }


    /**
     * Gets the messaggioRisultato value for this BEListOfUtentePaleoZA0HwLp5.
     * 
    ...
    /**
     * Sets the messaggioRisultato value for this BEListOfUtentePaleoZA0HwLp5.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof BEListOfUtentePaleoZA0HwLp5)) return false;
        BEListOfUtentePaleoZA0HwLp5 other = (BEListOfUtentePaleoZA0HwLp5) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(BEListOfUtentePaleoZA0HwLp5.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://paleo.regione.marche.it/services/", "BEListOfUtentePaleoZA0hwLp5"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://paleo.regione.marche.it/services/", "UtentePaleo"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        elemField.setItemQName(new javax.xml.namespace.QName("http://paleo.regione.marche.it/services/", "UtentePaleo"));
