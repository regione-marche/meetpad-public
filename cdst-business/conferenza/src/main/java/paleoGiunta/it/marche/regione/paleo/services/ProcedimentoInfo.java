...
public class ProcedimentoInfo {
	private java.lang.Integer numero;

    private java.lang.String stato;

    private paleoGiunta.it.marche.regione.paleo.services.TipoProcedimento tipo;
    ...
    public ProcedimentoInfo(
           ...
           paleoGiunta.it.marche.regione.paleo.services.TipoProcedimento tipo) {
           this.numero = numero;
           this.stato = stato;
           this.tipo = tipo;
    }
     ...
     * @return tipo
     */
    public paleoGiunta.it.marche.regione.paleo.services.TipoProcedimento getTipo() {
        return tipo;
    }
     ...
     * @param tipo
     */
    public void setTipo(paleoGiunta.it.marche.regione.paleo.services.TipoProcedimento tipo) {
        this.tipo = tipo;
    }
