...
public class BEListOfRubricaZA0HwLp5  implements java.io.Serializable {
    private paleoGiunta.it.marche.regione.paleo.services.Rubrica[] lista;

    private paleoGiunta.it.marche.regione.paleo.services.MessaggioRisultato messaggioRisultato;

    public BEListOfRubricaZA0HwLp5() {
    }

    public BEListOfRubricaZA0HwLp5(
    		paleoGiunta.it.marche.regione.paleo.services.Rubrica[] lista,
    ...
    /**
     * Gets the lista value for this BEListOfRubricaZA0HwLp5.
     * 
     * @return lista
     */
    public paleoGiunta.it.marche.regione.paleo.services.Rubrica[] getLista() {
        return lista;
    }


    /**
     * Sets the lista value for this BEListOfRubricaZA0HwLp5.
     * 
     * @param lista
     */
    public void setLista(paleoGiunta.it.marche.regione.paleo.services.Rubrica[] lista) {
        this.lista = lista;
    }


    /**
     * Gets the messaggioRisultato value for this BEListOfRubricaZA0HwLp5.
     * 
    ...
    /**
     * Sets the messaggioRisultato value for this BEListOfRubricaZA0HwLp5.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof BEListOfRubricaZA0HwLp5)) return false;
        BEListOfRubricaZA0HwLp5 other = (BEListOfRubricaZA0HwLp5) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(BEListOfRubricaZA0HwLp5.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://paleo.regione.marche.it/services/", "BEListOfRubricaZA0hwLp5"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://paleo.regione.marche.it/services/", "Rubrica"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        elemField.setItemQName(new javax.xml.namespace.QName("http://paleo.regione.marche.it/services/", "Rubrica"));
