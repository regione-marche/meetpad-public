...
public class DocumentoDTO extends IdentifiableDTO {
	...
	@JsonProperty("fileSignedFromUser")
	private Boolean fileSignedFromUser = false;
	
	@JsonProperty(value = "statusDocument")
	private String statoFirma;
	
	public Boolean getFileSignedFromUser() {
		return fileSignedFromUser;
	}

	public void setFileSignedFromUser(Boolean fileSignedFromUser) {
		this.fileSignedFromUser = fileSignedFromUser;
	}
