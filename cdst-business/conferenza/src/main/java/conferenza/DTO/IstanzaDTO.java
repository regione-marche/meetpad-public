...
public class IstanzaDTO {
	...
	@JsonProperty("dateUpdateList")
	private List<ModificaDataDTO> listaModificaData;
	...
	public List<ModificaDataDTO> getListaModificaData() {
		return listaModificaData;
	}

	public void setListaModificaData(List<ModificaDataDTO> listaModificaData) {
		this.listaModificaData = listaModificaData;
	}
	
	public void addListaModificaData(ModificaDataDTO modificaData) {
		if(this.listaModificaData == null) {
			this.listaModificaData = new ArrayList<ModificaDataDTO>();
		}
		this.listaModificaData.add(modificaData);
	}
}
