...
@Component("conferenza.firma.adapter.FSFirmaMultiplaAdapter")
public class FSFirmaMultiplaAdapter  implements IFirmaAdapter {

	private static final Logger logger = LoggerFactory.getLogger(FSFirmaMultiplaAdapter.class.getName());
	

	
	public FirmaDTO firma(FirmaDTO par1) {		
		logger.debug("[FSFirmaMultiplaAdapter.firma] - idDocumento  "+par1.getIdDocumento());		
	...
	public Resource getFile(FirmaDTO par1) {
		...
		logger.debug("[FSFirmaMultiplaAdapter.getFile] - idDocumento  "+par1.getIdDocumento());		
