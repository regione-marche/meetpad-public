...
@NamedNativeQueries({
		...
		@NamedNativeQuery(name = "Mailer.findAllMailerByConference", query =
					...
					"      INNER JOIN cdst.tipologia_conferenza_specializzazione tc ON tc.codice = cc.fk_tipologia_conferenza_specializzazione " +
		...
		@NamedNativeQuery(name = "Mailer.findAllMailerByConferenceForPaleo", query =
		"  select * from  " +
		"  (SELECT " +
		"      pc.id_partecipante || '-' || pp.id_persona as id,  " +
		"      cc.fk_stato,  " +
		...
		"  WHERE  " +
		"      1 = 1  " +
		"      and acc.data_fine is null and pc.data_fine is null and cc.data_fine is null and not(rp.codice='5')  and not(rpart.codice='2')" + // gets everything but RESPONSABILE and amm proc 
		"  UNION " +
		"  SELECT " +
		"      pc.id_partecipante || '-0' as id,  " +
		"      cc.fk_stato,  " +
		...
		"  WHERE  " +
		"      1 = 1  " +
		"  	AND ee.id_ente <> 0 and pc.data_fine is null and cc.data_fine is null and not(rpart.codice='1') and not(rpart.codice='2')" +
		"  UNION  "+
	    " SELECT "+
	    "     pc.id_partecipante || '-0-' || ep.email as id, "+
	    "    cc.fk_stato, "+
		...
		,@NamedNativeQuery(
				...
				query = " select"+
						...
						" cc.termine_richiesta_integrazioni_conferenza,"+ 
						" cc.termine_espressione_pareri,"+ 
						" cc.termine_espressione_pareri as data_termine,"+ 
						" cc.prima_sessione_simultanea,"+ 
						" cc.riferimento_istanza,"+ 
						"      cc.cap_sessione_simultanea, " +
						"      cc.fk_comune_sessione_simultanea, " +
						"      cc.fk_comune_sessione_simultanea as descrizione_comune_sessione_simultanea, " +
						"      cc.fk_provincia_sessione_simultanea, " +
						"      cc.fk_provincia_sessione_simultanea as descrizione_provincia_sessione_simultanea, " +
						"      cc.orario_conferenza ," +
...
public class Mailer implements Serializable {
	...
	@JsonProperty("fk_tipologia_conferenza_specializzazione")
	private String fk_tipologia_conferenza_specializzazione;

	@JsonProperty("descrizione_tipologia_conferenza_specializzazione")
	private String descrizione_tipologia_conferenza_specializzazione;
	...
	public String getFk_tipologia_conferenza_specializzazione() {
		return fk_tipologia_conferenza_specializzazione;
	}

	public void setFk_tipologia_conferenza_specializzazione(String fk_tipologia_conferenza_specializzazione) {
		this.fk_tipologia_conferenza_specializzazione = fk_tipologia_conferenza_specializzazione;
	}

	public String getDescrizione_tipologia_conferenza_specializzazione() {
		return descrizione_tipologia_conferenza_specializzazione;
	}

	public void setDescrizione_tipologia_conferenza_specializzazione(
			String descrizione_tipologia_conferenza_specializzazione) {
		this.descrizione_tipologia_conferenza_specializzazione = descrizione_tipologia_conferenza_specializzazione;
	}
