...
import conferenza.repository.bean.ReportMailKey;
...
@NamedNativeQueries({
	...
	,@NamedNativeQuery(
			...
			" ),registro as ( "+
			"  select 'conferenza@conferenza.it' as email_mittente, ret.email as email_destinatario,ret.fase_email,ret.fk_conferenza id_conferenza,ret.id_messaggio,ret.subject, "+ 
	...
	,@NamedNativeQuery(
			...
			query =	
			" select 'conferenza@conferenza.it' as email_mittente, ret.email as email_destinatario,ret.fase_email,ret.fk_conferenza id_conferenza,det.id_messaggio,ret.subject, "+ 
					" det.dt_sent_email,det.stato_email,det.nota   "+
