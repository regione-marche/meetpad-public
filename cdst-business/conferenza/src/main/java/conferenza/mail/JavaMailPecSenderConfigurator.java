...
public class JavaMailPecSenderConfigurator {
	...
	@Value("${mailPec.enableAsyncReinoltroNonAccettazionePec}")
	private boolean enableAsyncReinoltroNonAccettazionePec;
	...
	public boolean isEnableAsyncReinoltroNonAccettazionePec() {
		return enableAsyncReinoltroNonAccettazionePec;
	}

	public void setEnableAsyncReinoltroNonAccettazionePec(boolean enableAsyncReinoltroNonAccettazionePec) {
		this.enableAsyncReinoltroNonAccettazionePec = enableAsyncReinoltroNonAccettazionePec;
	}
