...
public class BEListOfOperatorePaleoZA0HwLp5  implements java.io.Serializable {
    private it.marche.regione.paleo.services.OperatorePaleo[] lista;
    ...
    public BEListOfOperatorePaleoZA0HwLp5(
           it.marche.regione.paleo.services.OperatorePaleo[] lista,
     ...
     * @return lista
     */
    public it.marche.regione.paleo.services.OperatorePaleo[] getLista() {
        return lista;
    }
     ...
     * @param lista
     */
    public void setLista(it.marche.regione.paleo.services.OperatorePaleo[] lista) {
        this.lista = lista;
    }
