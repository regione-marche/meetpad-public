...
public class BEListOfRubricaZA0HwLp5  implements java.io.Serializable {
    private it.marche.regione.paleo.services.Rubrica[] lista;
    ...
    public BEListOfRubricaZA0HwLp5(
           it.marche.regione.paleo.services.Rubrica[] lista,
     ...
     * @return lista
     */
    public it.marche.regione.paleo.services.Rubrica[] getLista() {
        return lista;
    }
     ...
     * @param lista
     */
    public void setLista(it.marche.regione.paleo.services.Rubrica[] lista) {
        this.lista = lista;
    }
