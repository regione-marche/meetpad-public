...
public class Allegato  implements java.io.Serializable {
    ...
    private it.marche.regione.paleo.services.File documento;

    private java.lang.Integer numeroPagine;

    private it.marche.regione.paleo.services.TipoOriginale originale;
    ...
    public Allegato(
           ...
           it.marche.regione.paleo.services.File documento,
           java.lang.Integer numeroPagine,
           it.marche.regione.paleo.services.TipoOriginale originale) {
     ...
     * @return documento
     */
    public it.marche.regione.paleo.services.File getDocumento() {
        return documento;
    }
     ...
     * @param documento
     */
    public void setDocumento(it.marche.regione.paleo.services.File documento) {
        this.documento = documento;
    }
     ...
     * @return originale
     */
    public it.marche.regione.paleo.services.TipoOriginale getOriginale() {
        return originale;
    }
     ...
     * @param originale
     */
    public void setOriginale(it.marche.regione.paleo.services.TipoOriginale originale) {
        this.originale = originale;
    }
