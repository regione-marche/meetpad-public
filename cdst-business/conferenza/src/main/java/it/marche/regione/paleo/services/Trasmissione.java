...
public class Trasmissione  implements java.io.Serializable {
    ...
    private it.marche.regione.paleo.services.TrasmissioneRuolo[] trasmissioniRuolo;

    private it.marche.regione.paleo.services.TrasmissioneUtente[] trasmissioniUtente;
    ...
    public Trasmissione(
           ...
           it.marche.regione.paleo.services.TrasmissioneRuolo[] trasmissioniRuolo,
           it.marche.regione.paleo.services.TrasmissioneUtente[] trasmissioniUtente) {
     ...
     */
    public it.marche.regione.paleo.services.TrasmissioneRuolo[] getTrasmissioniRuolo() {
        return trasmissioniRuolo;
    }
     ...
     */
    public void setTrasmissioniRuolo(it.marche.regione.paleo.services.TrasmissioneRuolo[] trasmissioniRuolo) {
        this.trasmissioniRuolo = trasmissioniRuolo;
    }
     ...
     */
    public it.marche.regione.paleo.services.TrasmissioneUtente[] getTrasmissioniUtente() {
        return trasmissioniUtente;
    }
     ...
     */
    public void setTrasmissioniUtente(it.marche.regione.paleo.services.TrasmissioneUtente[] trasmissioniUtente) {
        this.trasmissioniUtente = trasmissioniUtente;
    }
