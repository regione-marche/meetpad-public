...
public class PaleoServiceLocator extends org.apache.axis.client.Service implements it.marche.regione.paleo.services.PaleoService {
    ...
    public it.marche.regione.paleo.services.IPaleoService getBasicHttpBinding_IPaleoService() throws javax.xml.rpc.ServiceException {
    ...
    public it.marche.regione.paleo.services.IPaleoService getBasicHttpBinding_IPaleoService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            it.marche.regione.paleo.services.BasicHttpBinding_IPaleoServiceStub _stub = new it.marche.regione.paleo.services.BasicHttpBinding_IPaleoServiceStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (it.marche.regione.paleo.services.IPaleoService.class.isAssignableFrom(serviceEndpointInterface)) {
                it.marche.regione.paleo.services.BasicHttpBinding_IPaleoServiceStub _stub = new it.marche.regione.paleo.services.BasicHttpBinding_IPaleoServiceStub(new java.net.URL(BasicHttpBinding_IPaleoService_address), this);
                _stub.setPortName(getBasicHttpBinding_IPaleoServiceWSDDServiceName());
                return _stub;
            }
        }
