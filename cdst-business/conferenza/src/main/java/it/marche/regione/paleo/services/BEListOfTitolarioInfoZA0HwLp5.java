...
public class BEListOfTitolarioInfoZA0HwLp5  implements java.io.Serializable {
    private it.marche.regione.paleo.services.TitolarioInfo[] lista;
    ...
    public BEListOfTitolarioInfoZA0HwLp5(
           it.marche.regione.paleo.services.TitolarioInfo[] lista,
     ...
     * @return lista
     */
    public it.marche.regione.paleo.services.TitolarioInfo[] getLista() {
        return lista;
    }
     ...
     * @param lista
     */
    public void setLista(it.marche.regione.paleo.services.TitolarioInfo[] lista) {
        this.lista = lista;
    }
