...
public class BEListOfUtentePaleoZA0HwLp5  implements java.io.Serializable {
    private it.marche.regione.paleo.services.UtentePaleo[] lista;
    ...
    public BEListOfUtentePaleoZA0HwLp5(
           it.marche.regione.paleo.services.UtentePaleo[] lista,
     ...
     * @return lista
     */
    public it.marche.regione.paleo.services.UtentePaleo[] getLista() {
        return lista;
    }
     ...
     * @param lista
     */
    public void setLista(it.marche.regione.paleo.services.UtentePaleo[] lista) {
        this.lista = lista;
    }
