...
public class BEListOfUOInfoZA0HwLp5  implements java.io.Serializable {
    private it.marche.regione.paleo.services.UOInfo[] lista;
    ...
    public BEListOfUOInfoZA0HwLp5(
           it.marche.regione.paleo.services.UOInfo[] lista,
     ...
     * @return lista
     */
    public it.marche.regione.paleo.services.UOInfo[] getLista() {
        return lista;
    }
     ...
     * @param lista
     */
    public void setLista(it.marche.regione.paleo.services.UOInfo[] lista) {
        this.lista = lista;
    }
