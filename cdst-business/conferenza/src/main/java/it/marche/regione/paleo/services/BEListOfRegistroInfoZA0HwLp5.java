...
public class BEListOfRegistroInfoZA0HwLp5  implements java.io.Serializable {
    private it.marche.regione.paleo.services.RegistroInfo[] lista;
    ...
    public BEListOfRegistroInfoZA0HwLp5(
           it.marche.regione.paleo.services.RegistroInfo[] lista,
     ...
     * @return lista
     */
    public it.marche.regione.paleo.services.RegistroInfo[] getLista() {
        return lista;
    }
     ...
     * @param lista
     */
    public void setLista(it.marche.regione.paleo.services.RegistroInfo[] lista) {
        this.lista = lista;
    }
