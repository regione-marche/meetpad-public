...
public class BEBaseOfFileZA0HwLp5  implements java.io.Serializable {
    ...
    private it.marche.regione.paleo.services.File oggetto;
    ...
    public BEBaseOfFileZA0HwLp5(
           ...
           it.marche.regione.paleo.services.File oggetto) {
     ...
     * @return oggetto
     */
    public it.marche.regione.paleo.services.File getOggetto() {
        return oggetto;
    }
     ...
     * @param oggetto
     */
    public void setOggetto(it.marche.regione.paleo.services.File oggetto) {
        this.oggetto = oggetto;
    }
