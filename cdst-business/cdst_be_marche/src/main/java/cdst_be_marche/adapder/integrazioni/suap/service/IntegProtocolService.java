...
import cdst_be_marche.DTO.RispostaJson;
import cdst_be_marche.adapder.integrazioni.suap.IntegSuapAdapter;
...
import cdst_be_marche.protocollo.model.ObserverRegistryAudit;
import cdst_be_marche.protocollo.model.ObserverRegistryListener;
import cdst_be_marche.protocollo.repository.ObserverRegistryAuditRepository;
import cdst_be_marche.protocollo.repository.ObserverRegistryListnerInterface;
import cdst_be_marche.protocollo.service.ObserverRegistryListenerService;
...
public class IntegProtocolService implements ObserverRegistryListnerInterface{
	...
	public List<ObserverRegistryListener> findAllDocToSubmitToProtocol() {
		String par1="SCRITTURA-PROTOCOLLO-SUAP";
	...
	public void submitProtocol() {
		...
		for (ObserverRegistryListener item : listed) {
			...
			if (registroDocumento != null) {
				...
				logger.info("submitProtocol: "+protocollo.getMessage());
